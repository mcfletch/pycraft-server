...
public class PycraftEncoder {
    ...
    public PycraftEncoder(PycraftConverterRegistry registry) {
    ...
    public String encode(PycraftAPI api, Object message) {
        return this.registry.fromJava(api, message);
        // if (message instanceof Enum) {
        // return encode(((Enum) message).name());
        // } else if (message instanceof Integer || message instanceof Double || message
        // instanceof Float
        // || message instanceof Boolean) {
        // return message.toString();
        // } else if (message instanceof String) {
        // return String.format("\"%s\"",
        // ((String) message).replace("\\", "\\\\").replace("\t", "\\t").replace("\b",
        // "\\b")
        ...
        // content.add(String.format("%s:%s", encode(entry.getKey()),
        // encode(entry.getValue())));
        // }
        // return String.format("{%s}", String.join(",", content));
        // } else if (message instanceof String[] || message instanceof Object[] ||
        ...
        // List<Double> asList = Arrays.asList((Double) loc.getX(), (Double) loc.getY(),
        // (Double) loc.getZ());
        // return encode(asList);
        // } else if (message instanceof Vector) {
        // Vector vec = (Vector) message;
        // List<Double> asList = Arrays.asList((Double) vec.getX(), (Double) vec.getY(),
        // (Double) vec.getZ());
        // return encode(asList);
